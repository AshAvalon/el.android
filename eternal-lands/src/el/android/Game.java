...
public class Game extends GameRunner {
	...
	private void update_float_exp() {
		...
		// with green text color to show the last experience gained as in the
		// desktop client
		...
		final Toast floating_exp = Toast
				.makeText(Game.this,
						...
						Toast.LENGTH_SHORT);
		floating_exp.setGravity(Gravity.BOTTOM | Gravity.LEFT, 45, 45); // Approximately
																		// right
																		// of
																		// notification
																		// icon
		...
		// android default
		// short value is 2 seconds and it is not short enough. Because harvest
		// time between
		// simple harvestable items is less than 2 seconds. Reduce it to a
		// second or 0.75 seconds
